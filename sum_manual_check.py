                                ...
                                if genome =="hg38":
                                    ...
                                    if supp_reads:
                                        ...
                                        if strand == "+":
                                            ...
                                            supp_human_pos = supp_read.reference_end if supp_read.is_reverse else supp_read.reference_start
                                            tsd_pos = supp_human_pos + (human_clip_length - (supp_read.query_length - supp_read.query_alignment_start))
                                        elif strand == "-":
                                            human_clip_length -= offset
                                            supp_human_pos = supp_read.reference_start if supp_read.is_reverse else supp_read.reference_end
